...
Pod::Spec.new do |s|
  s.name             = 'SNPersian'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SNPersian.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/SinaKH/SNPersian'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'SinaKH' => 'sina_od@yahoo.com' }
  s.source           = { :git => 'https://github.com/SinaKH/SNPersian.git', :tag => s.version.to_s }
